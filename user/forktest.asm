...
forktest(void)
{
  ...
  34:	41050513          	addi	a0,a0,1040 # 440 <uptime+0xa>
  ...
  56:	43e50513          	addi	a0,a0,1086 # 490 <uptime+0x5a>
  5a:	fa7ff0ef          	jal	0 <print>
    exit(1);
  5e:	4505                	li	a0,1
  60:	33e000ef          	jal	39e <exit>
      exit(0);
  64:	33a000ef          	jal	39e <exit>
  }
  ...
  6c:	3e850513          	addi	a0,a0,1000 # 450 <uptime+0x1a>
  ...
  7e:	3ee50513          	addi	a0,a0,1006 # 468 <uptime+0x32>
  82:	f7fff0ef          	jal	0 <print>
    exit(1);
  86:	4505                	li	a0,1
  88:	316000ef          	jal	39e <exit>
  for(; n > 0; n--){
  8c:	00905963          	blez	s1,9e <forktest+0x7a>
    if(wait(0) < 0){
  90:	4501                	li	a0,0
  92:	314000ef          	jal	3a6 <wait>
  ...
  ae:	3d650513          	addi	a0,a0,982 # 480 <uptime+0x4a>
...
stat(const char *n, struct stat *st)
{
 ...
 24e:	84aa                	mv	s1,a0
  ...
  r = fstat(fd, st);
 250:	85ca                	mv	a1,s2
 252:	1a4000ef          	jal	3f6 <fstat>
 256:	892a                	mv	s2,a0
  close(fd);
 258:	8526                	mv	a0,s1
 25a:	16c000ef          	jal	3c6 <close>
  return r;
 25e:	64a2                	ld	s1,8(sp)
}
 260:	854a                	mv	a0,s2
